//===-- RISCZELFStreamer.h - RISCZ ELF Target Streamer ---------*- C++ -*--===//
//
...
#ifndef LLVM_LIB_TARGET_RISCZ_MCTARGETDESC_RISCZELFSTREAMER_H
#define LLVM_LIB_TARGET_RISCZ_MCTARGETDESC_RISCZELFSTREAMER_H
...
class RISCZTargetELFStreamer : public RISCZTargetStreamer {
private:
...
public:
  ...
  RISCZTargetELFStreamer(MCStreamer &S, const MCSubtargetInfo &STI);
...
#endif // LLVM_LIB_TARGET_RISCZ_MCTARGETDESC_RISCZELFSTREAMER_H