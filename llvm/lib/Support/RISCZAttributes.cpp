//===-- RISCZAttributes.cpp - RISCZ Attributes ----------------------------===//
//
...
using namespace llvm::RISCZAttrs;
...
constexpr TagNameMap RISCZAttributeTags{TagData};
const TagNameMap &llvm::RISCZAttrs::getRISCZAttributeTags() {
  return RISCZAttributeTags;
}